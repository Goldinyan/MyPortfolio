    ...
    <>
      <div className="w-full min-h-screen bg-bg-black overflow-x-hidden bg-top-splash">
        <div className="flex-col items-center justify-center">
          ...
          <div
            onClick={() => router.push("/")}
            className="flex flex-ro group  transition-all  gap-2 items-center justify-center text-black bg-text-secondary w-50 mt-8 mx-auto  px-3 py-2 font-medium rounded-lg "
          >
...
function TiltCard({ children }: { children: React.ReactNode }) {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    const rotateX = ((y - centerY) / centerY) * 20; // max 20
  ...
  return (
    <div
      className="bg-bg-black rounded-2xl border-2 border-border-bg p-5 mx-2 my-2 transition-transform duration-200 ease-out will-change-transform"
      style={style}
